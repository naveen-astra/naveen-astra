...
# CONFIG
# ----------------------------------------------------------------------------
WINDOW_TITLE = "naveen"  # cosmetic label shown in the terminal titlebar
...
INFO = [
    ...
    ("Focus",    "AI Agents  ·  Full-Stack Development  ·  Intelligent Automation", "accent"),
    ("__blank__", "", ""),
    ("__section__", "~/stack", ""),
...
def render(theme_name, colors):
    ...
    parts.append(
        ...
        f'{escape(WINDOW_TITLE)} — zsh — 90×26</text>'
    )
